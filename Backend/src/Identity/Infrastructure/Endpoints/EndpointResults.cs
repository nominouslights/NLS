...
/// always <c>{ code, message }</c> — the shape frontends parse. Mirrors Fleet's
/// <c>Infrastructure/Endpoints/EndpointResults.cs</c>; each domain library keeps its own copy
/// since domain libraries never reference each other.
/// </summary>
