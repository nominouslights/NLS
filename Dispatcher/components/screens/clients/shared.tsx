...
import type { Client, InteractionType } from "@/lib/types";
 ...
 *  Vendor/Partner records (tagged "Vendor / Partner") don't get the CRM UI yet. */
export function isClientType(client: Client): boolean {
  return !/vendor|partner/i.test(client.tag);
}
