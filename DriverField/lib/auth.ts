// ---------------------------------------------------------------------------
// Auth module — token lifecycle for the Driver Field App.
//
// ADAPTED FROM Dispatcher/lib/auth.ts, via Budgeting/lib/auth.ts. Four deliberate differences,
// everything else identical:
//   1. REFRESH_TOKEN_KEY is app-specific, so the apps cannot collide if they are ever served
//      from one hostname — which they are, under path prefixes, in the DigitalOcean image.
...
const REFRESH_TOKEN_KEY = "nl.driverfield.refreshToken";
